...
ActiveRecord::Schema.define(version: 20170930212446) do

  create_table "personalreferences", force: :cascade do |t|
    ...
    t.index ["requisition_id"], name: "index_personalreferences_on_requisition_id"
  end
